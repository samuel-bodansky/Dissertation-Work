...
\end{example}
\begin{example}[Due to Kondo]
 Let $f(x)=x^7-x^6-x^5+x^4-x^3-x^2+2x+l$ , and $F$ and $K$ be as above.
Then $d(f)=d(F)=-357911=-71^{3}$ and $f(x)=(x+15)(x+22)^{2}(x+47)^{2}(x+65)^{2}mod 71$ .
