...
The following definitions will be useful in analysing the class field of polynomials when the class group of the splitting field is nontrivial.
2003, 499,[9,8,-24,-20,0,1] using magma, class field isomorphic to V4
\begin{definition}
...
% x^5 - 2*x^4 - 20*x^3 + 6*x^2 + 89*x + 67
