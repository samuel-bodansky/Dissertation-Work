...
\end{example}
\section{More Yamamura Results}
\cite{YAMAMURA1996} gives the following result for imaginary quadratic number fields with class number two.
\begin{theorem}
Suppose $K$ is an imaginary quadratic number field with class number 2, i.e. $K=\Q(\sqrt{-d}))$, where $d= 5, 20, 24, 35, 40, 51, 52, 88, 91, 115, 123, 148, 187, 232, 235, 267, 403$, or $427$. 
\end{theorem}
\section{Important Results from Class Field Theory}
...
\section{Results on Cubic Field Extensions}
