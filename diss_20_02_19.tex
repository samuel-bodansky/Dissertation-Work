...
\begin{theorem}
Suppose that H is a positive integer, and L is an unramified normal extension of K of degree M. Here are two possible cases that can occur: Suppose L is an unramified degree m  normal extension of K with h(L)=1, and 
\begin{equation}
